<div class="box box-warning color-palette-box" style="margin-top:15px">
    <div class="box-header with-border">
        ...
        <?php echo anchor(site_url('pegawai/request/progres/'.$id_request.'/progres-request'), '<< Kembali ', array('class'=>'text-warning tultip','title'=>'Kembali ke halaman sebelumnya')); ?>
        </div>
    </div>
