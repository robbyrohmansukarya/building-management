                ...
                <table class="table table-bordered display responsive nowrap" id="" cellspacing="0" width="100%">
                    <tbody> 
                        ...
                        <tr>
                            ...
                            <td>
							<?php 
                                echo ($photo == '' ? 'Tidak ada lampiran foto' : anchor('pegawai/request/photo/'.$id_request.'/detail-lampiran','Link Pic'));
                            ?>         
                            </td>
                        </tr>
                        <tr>
        ...
        <table class="table table-bordered table-striped display responsive nowrap" id="mytable" cellspacing="0" width="100%">
            ...
            ?>
            	<tr>
                    ...
                    <td>
					<?php 
						echo ($row->foto_lokasi == '' ? 'Tidak ada lampiran foto' : anchor('pegawai/request/photo_progres/lokasi/'.$row->id.'/'.$id_request.'/foto-lokasi','Link Pic'));
					?>
                    </td>
                    <td>
					<?php 
						echo ($row->foto_progres == '' ? 'Tidak ada lampiran foto' : anchor('pegawai/request/photo_progres/progres/'.$row->id.'/'.$id_request.'/foto-progres','Link Pic'));
					?>
                    </td>
                </tr>
			<?php    
