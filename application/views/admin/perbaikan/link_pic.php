<div class="box box-warning color-palette-box" style="margin-top:15px">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <?php echo anchor(site_url('admin/perbaikan/progres/'.$id_request.'/progres-request'), '<< Kembali', array('class'=>'tultip btn btn-info btn-xs','title'=>'Kembali ke halaman sebelumnya'));?>
        </div>
    </div>
