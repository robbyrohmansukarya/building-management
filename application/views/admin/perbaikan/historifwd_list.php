				...
				<tr>
					...
					<?php
						...
						if($qpegawai->num_rows() > 0){
							...
							echo anchor('admin/perbaikan/progres'.'/'.$row->id_request.'/progres-request', ucwords($pegawai->nama_lengkap), array('class'=>'small-box-footer tultip', 'title'=>'klik untuk melihat progres request','data-toggle'=>'tooltip'));
						}
						else{
                    ...
                    <td>
					<?php 
						echo anchor('admin/perbaikan/progres'.'/'.$row->id_request.'/progres-request', '<i class="fa fa-wrench"></i> Progres ', array('class'=>'small-box-footer tultip', 'title'=>'klik untuk melihat progres request','data-toggle'=>'tooltip'));
