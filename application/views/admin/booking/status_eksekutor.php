<div class="row">
    ...
    <div class="callout callout-warning" style="margin:15px 15px 15px 100px;">											
      ...
      Hallo Operator, Saat ini anda sedang melihat daftar booking ruangan yang telah di forward ke All Eksekutor <br> Salam & Terimakasih
    </div>
</div>
        ...
        <table class="table table-bordered table-striped display responsive nowrap" id="mytable" cellspacing="0" width="100%">
            ...
            ?>
                <tr>
                    ...
                    <?php 
                        echo anchor('admin/ruangan/detail_sts_eksekutor/'.$row->id_request.'/detail-status-eksekutor', '<i class="fa fa-info-circle"></i> Status Eksekutor ', array('class'=>'small-box-footer tultip', 'title'=>'status dari eksekutor','data-toggle'=>'tooltip'));
                        echo '&nbsp;&nbsp; | &nbsp;&nbsp;'; 
