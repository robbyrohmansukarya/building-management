<div class="box box-warning color-palette-box" style="margin-top:15px">
    <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-user"></i> Detail Admin</h3>
    ...
    <table class="table table-bordered table-striped display responsive nowrap" id="mytable" cellspacing="0" width="100%">
        <tr>
            ...
            <div class="col-lg-12 col-md-12 col-xs-12">
             <img src="<?php echo base_url().'assets/dist/img/admin/'.($photo =='' ? 'avatar04.png':$photo);?>" class="img-thumbnail img-responsive" alt="User Image" />
             </div>
            </td>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
			...
			<?php 
				if($query->pwd != md5($idpengguna)){
					echo '<strong>*****</strong>'; 				
					echo anchor('admin/admin/ubah_pwd/'.$idpengguna.'/ubah-password', '<i class="fa fa-repeat"></i> Resset Password', array('class'=>'btn btn-flat btn-danger btn-xs', 'onclick'=>'return confirm(\'Anda akan merubah password admin, Lanjutkan ?\');'));
				}else{
